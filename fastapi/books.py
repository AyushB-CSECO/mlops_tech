...
BOOKS = [
    Book(1, "Animal Farm", "George Orwell", "Political Satire", 5),
    Book(2, "Atomic Habbits", "James Clear", "Helps in building good habbits", 4),
    Book(3, "Five Point Someone", "Chetan Bhagat", "Story about College Friends", 3),
    Book(4, "Revolution 2020", "Chetan Bhagat", "Struggles of an average middle class boy", 4),
    Book(5, "The Rudest Book Ever", "Shwetabh Gangwar", "Self Help Book on Life", 5),
    Book(6, "Let Us C", "Yashwant Kanetkar", "Book on C++ coding", 4)
]
